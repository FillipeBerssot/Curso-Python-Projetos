...
crescimento_pais_a = float(input('Informe agora a porcentagem da taxa de crescimento do país A: '))

pais_b = float(input('Informe aqui a quantidade de habitantes no país B: '))
crescimento_pais_b = float(input('Informe agora a porcentagem da taxa de crescimento do país B: '))
